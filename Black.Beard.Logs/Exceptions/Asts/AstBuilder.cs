        ...
        public class ILAstBuilder
        {
            ...
            sealed class ByteCode
            {
                ...
                public bool IsVariableDefinition
                {
                    get
                    {
                        return (this.Code == OpCodes.Stloc) || (this.Code == OpCodes.Ldloca && this.Next != null && this.Next.Code == ILCode.Initobj);
                    }
                }
            ...
            public List<ILNode> Build(MethodBase methodDef, bool optimize, DecompilerContext context)
            {
            ...
            List<ByteCode> StackAnalysis(MethodInfo methodDef)
            {

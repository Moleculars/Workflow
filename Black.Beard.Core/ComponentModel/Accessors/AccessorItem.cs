...
namespace Bb.ComponentModel.Accessors
{
    ...
    public class AccessorItem
    {
        ...
        ///// <returns></returns>
        //public static AccessorList Get(Type componentType, bool compute, bool withSubType = false)
        //{
        //    #warning method a supprimer une fois que Philip aura migré toutes ses methodes
        //    return Get(componentType, withSubType);
        //}
        ...
        /// <param name="withSubType">if set to <c>true</c> [with sub type].</param>
        /// <returns></returns>
        public static AccessorList Get(Type componentType, bool withSubType = false)
        {

...
namespace Bb.Workflow.Service.Configurations
{
    ...
    public static class ConfigurationExtensions
    {
        ...
        /// <returns></returns>
        public static HostContextBuilder InitializeWorkflowConfiguration(this HostContextBuilder hostContextBuilder)
        {
        ...
        {
            services.AddTransient<HostContextBuilder>(ctx => hostContextBuilder.CreateLocalContext(ctx));
            return services;
        }
